...
# Erstellen einer App {#create-an-app}
...
* **[!UICONTROL App Summary]**: bietet einen Überblick über den Inhalt und den Status der App und bietet Tools für den Zugriff auf die App auf ihrer Website und den Einbettungscode.
* **[!UICONTROL Designer]**: ermöglicht es Ihnen, Designoptionen für die App auszuwählen, einschließlich Schriftarten, Farbschemas und App-spezifischen Konfigurationsoptionen.
* **[!UICONTROL Streams]**: listet alle Stream-Quellen für den Inhalt der App auf. Klicken Sie auf den Stream-Titel, um die Stream-Detailseite zu öffnen, von der sie bearbeitet werden kann.
* **[!UICONTROL Settings]**: können Sie App-spezifische Einstellungen auswählen, einschließlich Regeln zum Hinzufügen von Inhalten zur App und der anzuzeigenden Inhaltstypen. Klicken Sie auf die **[!UICONTROL Settings]** Registerkarte, um das Netzwerk und die Site-Einstellungen für die App zu überschreiben.
...
* **[!UICONTROL Content Count]**: Listet die Anzahl der Inhalte auf, die in der App veröffentlicht wurden.
* **[!UICONTROL Date Modified]**: Listet das letzte Mal auf, wenn die App in App Designer geändert wurde.
...
* **[!UICONTROL Brand color]**. Wählen Sie eine Farbe für Ihre App aus. Diese Farbe wird für Hashtags, urls, Benutzernamen, @ Erwähnungen, Balkendiagramme und andere App-spezifische Komponenten verwendet, wie im Vorschaufenster rechts angezeigt.
* **[!UICONTROL Font family]**. Wählen Sie eine Schriftart für benutzergenerierte Inhalte in Ihrer App aus. Wenn Sie Georgia oder Times New Roman auswählen, wird diese Schriftart dem Inhalt zugewiesen und Helvetica neu zu Benutzernamen und Anzeigenamen. Wenn Sie Helvetica, Verdana oder Trebooket auswählen, werden diese Schriftarten Inhalten, Benutzernamen und Anzeigenamen zugewiesen.
* **[!UICONTROL Font size]**. Wählen Sie eine Standardschriftgröße aus. Diese Einstellung wirkt sich auf alle benutzergenerierten Inhalte und Titel aus, die in der App angezeigt werden.

## Apps aktualisieren {#section_iwb_4bz_vcb}

Wenn eine neuere Version der App vorhanden ist, wird eine **[!UICONTROL Update]** Schaltfläche angezeigt.

Klicken Sie auf die Schaltfläche, um die aktuelle Version zu aktualisieren. Aktualisieren Sie Ihre App, um alle verfügbaren Funktionsverbesserungen und Fehlerkorrekturen zu verwenden. Nachdem Sie sich aktualisiert haben, können Sie die Änderungen an Ihrer App (falls vorhanden) in der Vorschau anzeigen oder ablehnen oder ablehnen.

## Hinzufügen einer Aktionsaktionsschaltfläche zu einer App {#section_cpf_cmt_bbb}

Fügen Sie eine Aktionsaufruf-Schaltfläche hinzu, um die Konversion von UGC zu steigern.

So fügen Sie einer App eine Aktionsaufruf-Schaltfläche hinzu:

1. Erstellen einer Mosaic- oder Medienwall-App.
...
Mit App Designer können Sie eine Vorschau Ihrer App in verschiedenen Auslieferungsformaten und mit Ihren eigenen oder Musterdaten anzeigen.

Wählen **[!UICONTROL Exit Preview]** Sie diese Option, um zum Designmodus zurückzukehren.

Der Vorschaumodus bietet die folgenden Optionen:

* **[!UICONTROL Preview Options]**: Wählen Sie im Pulldown-Menü ein Vorschauformat (Mobil, Tablet oder Desktop) und ob die Stream-Daten der App angezeigt **[!UICONTROL Sample Data]** werden sollen.
...
>[!NOTE]
>
>Der Vorschaumodus ist vollständig interaktiv, sodass Sie die Benutzererfahrung für Ihre App testen können. Wenn Sie aktivieren **[!UICONTROL Allow user posts]**, können Benutzer mit dem Vorschaulink auf die **[!UICONTROL What’s on your mind]** Schaltfläche klicken und Inhalte in Ihre Testversion einfügen. Studio listet Inhalte wie gepostet auf.

## App-Veröffentlichung {#section_df1_smt_bbb}

App Designer speichert Ihre App automatisch, nachdem Sie eine Änderung vorgenommen haben. Sie können einen **[!UICONTROL Publish]** Einbettungscode erstellen oder alle bereits veröffentlichten Versionen dieser App mit der aktuellen Version aktualisieren.
...
App Designer speichert Ihre App automatisch, nachdem Sie eine Änderung vorgenommen und für jede Änderung eine neue Version generiert haben. Sie können ein **[!UICONTROL History]** Bedienfeld öffnen, in dem alle Versionen Ihrer App aufgelistet sind. In den aufgeführten Versionen werden der Editor der einzelnen Versionen und deren Alter angezeigt.

So überprüfen Sie den App-Verlauf:

1. Klicken Sie auf eine Version, um sie auszuwählen.
1. Aktualisieren Sie die Vorschau.
1. Klicken **[!UICONTROL Restore Version]** Sie auf, um die ausgewählte Version zu klonen und daran zu arbeiten.
1. Klicken Sie auf die Zurück-Schaltfläche, um **[!UICONTROL Version History]** zu Ihrem Arbeitsentwurf zurückzukehren.
1. Klicken **[!UICONTROL Share]** Sie auf, um eine URL für die Vorschau zu generieren.
...
## App mit Studio auf Ihre Site einbetten {#section_w3h_1nt_bbb}

Erstellen Sie den Einbettungscode.
...
## Löschen einer App {#section_zyx_zyx_xcb}

Sie können eine App aus der Apps-Liste in Livefyre Studio löschen. Wenn Sie die App aus Studio löschen, wird die App aus der Ansicht ausgeblendet und wird nicht gelöscht oder beendet:

* Die App funktioniert weiterhin auf einer Site.
* Verbundene Streams.
* Verknüpfte Sammlungen in Livefyre.
