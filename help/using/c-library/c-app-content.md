---
description: Verwalten von Inhalten über Ihr Livefyre-Netzwerk.
seo-description: Verwalten von Inhalten über Ihr Livefyre-Netzwerk.
...
Livefyre-Suchfelder unterstützen Platzhalter, mit denen Sie ein Sternchen (*) zu Wörtern (oder Wortfragmenten) hinzufügen können, um teilweise Übereinstimmungen zu fangen.

Beispiel:

* ball gibt nur Ball zurück.
* ball * gibt ball und Ballon zurück
* * ball gibt ball und football zurück
* * ball * gibt ball und Uniball und Schrägstrich zurück

## Suche nach Inhalten {#section_fw1_mtm_zz}

Mit dem App Content-Bedienfeld können Sie Ihre Suche mit verschiedenen Filteroptionen für Inhalte eingrenzen.
...
In Apps wird **[!UICONTROL Bozo]** der Inhalt nur dem Autor des Inhalts angezeigt. Dadurch kann der Benutzer glauben, dass sein Inhalt genehmigt wurde, während er von allen anderen Benutzern und Moderatoren ausgeblendet wird.
...
Im Inhaltsbedienfeld können Sie den Verlauf aller aufgelisteten Inhalte überprüfen, einschließlich Prämoderation, Spam-Filterung, Datum des Beitrags und beliebige Benutzerflags oder Hinweise, die dem Element zugewiesen sind.

Verwenden Sie die Registerkarten am unteren Rand des Inhalts-Bedienfelds, um den Verlauf anzuzeigen.

* **[!UICONTROL More Info:]** listet alle Aktivitäten auf diesem Inhalt auf, einschließlich Übermittlung, Bearbeitung, Spam-Prüfung, Statusänderung und Notizen. Die Livefyre-Inhalts-ID und die IP-Adresse des Benutzers werden ebenfalls in diesem Abschnitt angezeigt.
* **[!UICONTROL Replies:]** listet maximal 6 Antworten auf. Klicken **[!UICONTROL Show all replies]** Sie auf, um alle Antworten auf den Beitrag anzuzeigen.

* **[!UICONTROL Flags & Reports:]** listet alle Benutzerflags mit dem Avatar des Benutzers auf, der den Inhalt markiert hat, sowie alle Berichte (Hinweise, die vom Benutzer beim Kennzeichnen des Inhalts hinzugefügt wurden).
* **[!UICONTROL Add a note:]** können Sie eine Notiz hinzufügen, die für andere Administratoren oder Moderatoren sichtbar ist.
* **[!UICONTROL Request Rights:]** öffnet das **[!UICONTROL New Rights Request]** Dialogfeld, von dem aus eine Rights Request ausgegeben werden kann.

* ****[!UICONTROL Save as Asset:]öffnet das **[!UICONTROL Advanced Options]** Dialogfeld, mit dem Sie das ausgewählte Element in Ihrer Asset-Bibliothek speichern, es in einer App veröffentlichen oder die Wiederverwendungsrechte von seinem Autor abrufen können.

![](assets/PublishedMoreInfo-1024x462.png)

## Hinzufügen eines Tags zu Inhalten {#section_xb4_mxr_rdb}

Mit Tagging-Inhalten können Sie Inhalte für einfache Abruf- und Stilanpassungen kategorisieren und organisieren oder Inhalte wie empfohlen markieren.

Um Tags hinzuzufügen, klicken Sie einfach unter dem Inhalt auf das Pluszeichen ( **[!UICONTROL +]**). Geben Sie ein neues Tag ein oder wählen Sie aus einer Liste vorhandener Tags aus.
...
* Eingeben von Text in das **[!UICONTROL Tags]** Feld, um nach intelligenten Tags zu suchen. Der Ranking-Algorithmus für Smart Tags filtert Inhalte mithilfe eines intelligenten Tag-Tag-Konfidenzwerts, wie neu der Inhalt ist und wie viele Sterne ein Benutzer den Inhalt gab.

## Dargebotenen Inhalt {#section_emb_kqm_zz}

Wählen Sie das Standard **[!UICONTROL Featured]** -Tag aus, um den Inhalt wie gewünscht zu markieren und ihn für Ihre Benutzer besonders hervorzuheben. Verwenden Sie nach dem Tagging benutzerdefinierte Formatierungsoptionen, um spezielle Inhalte in Ihren Apps anzupassen.

## So funktioniert oder unfunktionsfähig {#section_ojx_3qm_zz}

* Klicken Sie aus Studio auf das **[!UICONTROL +]** Symbol neben einem Inhaltselement, wählen Sie das **[!UICONTROL Featured]** Tag in der Dropdown-Liste aus und klicken **[!UICONTROL Enter]** Sie auf Inhalt. Das Tag wird gespeichert und neben dem Inhaltselement angezeigt.
...
>[!NOTE]
>
>Aufgrund von Leerzeichen können Chat-Inhalte unter Umständen nur mit Studio oder nicht in der App dargestellt werden.

## Bearbeiten von speziellen Inhalten {#section_pyw_hqm_zz}

Die meisten regelmäßigen Aktionen für Inhalte können auf speziellen Inhalten vorgenommen werden, mit Ausnahme der folgenden:

* Dargestellte Inhalte können nicht markiert werden.
* Benutzer können ihren Inhalt nicht bearbeiten, nachdem sie angegeben wurden, obwohl sie sie trotzdem trotzdem löschen können. Moderatoren können spezielle Inhalte bearbeiten.
